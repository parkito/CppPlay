...
// you cannot use the unsigned or signed modifiers with floating-point types; floating-point types
// are always signed. https://www.learncpp.com/cpp-tutorial/floating-point-numbers/
int main() {
